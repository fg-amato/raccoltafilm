...
public class CheckAuthFilter implements Filter {
	...
	private static final String[] PROTECTED_URLS = {"/users/", "/ExecuteDeleteRegistaServlet", "/PrepareDeleteRegistaServlet","/PrepareDeleteFilmServlet", "/ExecuteDeleteFilmServlet"};
